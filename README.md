...
The navigation bar is present on the homepage and hides when scrolling down but appears when scrolling up. It is easily noticeable, intuitive, and easy to use. The navigation bar highlights the selected page where the user is located. On the left side is the site Logo with the navigation links to the right, the navbar is responsive and changes to the common hamburger menu style when moving to Tablet or Mobile devices.
